...
class AnimatedBackgroundLight extends StatefulWidget {
  const AnimatedBackgroundLight({Key? key}) : super(key: key);

  @override
  _AnimatedBackgroundState createState() => _AnimatedBackgroundState();
}

class _AnimatedBackgroundState extends State<AnimatedBackgroundLight>
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final particlePaint = Paint()
      ..shader = RadialGradient(
        colors: [
          Color(0xff5e0b8b).withOpacity(0.9), Color(0xff5e0b8b).withOpacity(0.7),
        ],
    ...
    for (var i = 0; i < particles.length; i++) {
      ...
      for (var j = i + 1; j < particles.length; j++) {
        ...
        if (distance < connectDistance) {
          ...
          connectionPaint.color = Color(0xff5e0b8b)
              .withOpacity(alpha)
              .withGreen(200)
              .withRed(200);
    ...
    for (var particle in particles) {
      ...
      canvas.drawCircle(
        ...
        particle.radius * 1.5,
        Paint()
          ..color = Color(0xff5e0b8b).withOpacity(0.15)
      ...
      if (touchPosition != null) {
        ...
        if (cursorDistance < connectDistance) {
          ...
          connectionPaint.color = Color(0xff5e0b8b).withOpacity(alpha);
          ...
          if (cursorDistance < connectDistance * 0.6) {
            canvas.drawCircle(
              ...
              Paint()
                ..color = Color(0xff5e0b8b).withOpacity(alpha * 0.3)
    ...
    if (touchPosition != null) {
      canvas.drawCircle(
        ...
        30,
        Paint()
          ..color = Color(0xff5e0b8b).withOpacity(0.2)
