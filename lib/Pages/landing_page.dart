      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const AnimateOnVisibility(
              key: Key('cta-cost'),
              child: Text('Demo System Cost: \$590', style: TextStyle(fontSize: 18, color: Colors.white70)),
            ),
          ],
        ),
      ),
